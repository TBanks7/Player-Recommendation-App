...
const SimilarityEngine = ({similarityData}) => {
  console.log(similarityData.similar_players)
  ...
  return (
    <div className="basis-2/6">
      ...
      <div className="flex flex-col gap-4 mt-4">
        {/* {similarPlayersData.map (player => (
          <div key={player.id}>
            {player.Player}
          </div>
        ))} */}
        {similarPlayersData.map(player => {
          const playerId = player.Url.split('/')[5]; // Extract "1f44ac21"
              ...
              <div className='flex gap-4'>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {player.TmPos} | {player.player_foot} | Age: {player.Age}
                  </p>
                </div>
              </div>
